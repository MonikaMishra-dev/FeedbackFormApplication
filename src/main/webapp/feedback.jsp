...
<form action="<%= application.getContextPath() %>/feedback" method="post">
 ...
 <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Your Feedback Message</label>
    <textarea name="feedbackMessage" class ="form-control" rows="10" placeholder="Enter here" cols=""></textarea>
  </div>
